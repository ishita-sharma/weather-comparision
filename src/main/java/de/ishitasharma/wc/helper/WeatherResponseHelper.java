...
public class WeatherResponseHelper {
	...
	private String buildResponse(
			String nameOfSecondCity, StringBuilder sb, String comparision,
			double tempFromCity1, double tempFromCity2) {
		return sb.append(SPACE).append(tempFromCity1).append(comparision).append(nameOfSecondCity).append(SPACE).append(tempFromCity2).toString();
	}
